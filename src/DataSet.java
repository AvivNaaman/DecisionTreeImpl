...
public class DataSet {
  ...
  public String pluralityValue() {
    if (this.instances.isEmpty())
      return null;
    return this.instances.stream().map(Instance::getLabel)
      .collect(Collectors.groupingBy(Function.identity(), Collectors.counting()))
      .entrySet()
      .stream()
      .max(Map.Entry.comparingByValue())
      .orElse(new AbstractMap.SimpleEntry<String, Long>(null, 0L)).getKey();
  }

  public boolean allLabeledSame() {
  ...
  public String getMostImportantAttribute(List<String> attributes) {
  ...
  public double attributeRemainder(String attribute) {
    double simpleSum = 0;
  ...
  private int[] getFilteredCounts(String attribute, String value) {
  ...
  public DataSet getFiltered(String attribute, String value) {
